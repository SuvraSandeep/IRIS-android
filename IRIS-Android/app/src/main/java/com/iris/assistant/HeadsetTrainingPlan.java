 ...
 *  the wake sound and the same owner. Enrollment count matches SoundWakeProfile's hard floor of
 *  10 examples exactly (its constructor requires between 10 and 12); verification count matches
 *  the phone-route plan's 4 held-out takes for the same held-out-validation guarantee. */
