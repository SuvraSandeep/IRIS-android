...
Authenticated saving starts wake-mode listening automatically.
...
The source archive excludes signing keystores. A source-only build uses the local Android debug key; repository builds preserve their existing signing configuration.
